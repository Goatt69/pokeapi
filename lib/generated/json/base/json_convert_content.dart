...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<PokecardEntity>[] is M) {
      return data.map<PokecardEntity>((Map<String, dynamic> e) =>
          PokecardEntity.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (PokecardEntity).toString(): PokecardEntity.fromJson,
  };
